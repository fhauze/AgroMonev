    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={cn(
            "text-sm font-medium",
            !online && "text-amber-700",
            online && isSyncPending && "text-yellow-700",
            online && !isSyncPending && "text-emerald-700"
          )}
        >
          {!online && "Offline"}
          {online && isSyncPending && "Online (Belum Sinkron)"}
          {online && !isSyncPending && "Online"}
        </p>
        ...
        <p
          className={cn(
            ...
            online && isSyncPending && "text-yellow-600",
            online && !isSyncPending && "text-emerald-600"
          )}
        >
          {!online && "Data disimpan lokal"}
          {online && isSyncPending && `${pendingCount} data menunggu sinkronisasi`}
          {online && !isSyncPending && "Semua data tersinkronisasi"}
        </p>
      </div>
    </div>
  );
